 ...
 * 
 */
public class TestResultListener_New extends TestListenerAdapter {

	private static Logger logger = Logger.getLogger(TestResultListener_New.class.getName());
	...
	String path="test-output\\ResultXML\\failed.xml";
	File file=new File(path);
	FileWriter fileWriter=null;
	//输出成功结果详细信息
	public static StringBuffer sb2=new StringBuffer("<?xml version=\"1.0\" encoding=\"utf-8\"?>\n<passed>\n");
	String path2="test-output\\ResultXML\\passed.xml";
